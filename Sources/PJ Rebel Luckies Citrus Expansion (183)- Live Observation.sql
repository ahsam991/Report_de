...
SELECT
        ...
        q."6" "telling_about_coolcrunch_variant",
        q."7" "telling_about_luckies_citrus",
        q."8" "showing_av",
        q."9" "asking_about_trial",
        q."10" "telling_about_ptr",
        q."11" "telling_about_citrus_availability"
FROM qu_ans q
